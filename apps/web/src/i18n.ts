...
export const translations = {
  en: {
    ...
    confirmDeleteJournalItem: "Delete this journal item? This cannot be undone.",
    journalItemUpdated: "Journal item updated.",
    journalItemDeleted: "Journal item deleted.",
    failedUpdateJournalItem: "Failed to update journal item.",
    failedDeleteJournalItem: "Failed to delete journal item.",
    refresh: "Refresh",
    ...
    initializeBook: "Initialize book",
    initializingBook: "Initializing...",
    selectedSource: "Selected",
    supportedSourceFormats: "Supported: PDF, EPUB, DOCX, TXT, Markdown, HTML, RTF.",
    sourcePath: "Source",
    sourcePathPlaceholder: "/Users/me/Books/book.pdf",
    selectSource: "Choose source",
    workspaceTarget: "Save as",
    workspaceTargetOptional: "Save as (optional)",
    workspaceTargetPlaceholder: "/Users/me/Reading/book-reading",
    webWorkspaceTargetPlaceholder: "workspaces/book-name-reading",
    ...
    confirmDeleteWorkspace:
      "Delete this initialized book and all notes in its workspace? This cannot be undone.",
    ...
    obsidianExportMode: "Export mode",
    obsidianLearningArchiveMode: "Learning archive (recommended)",
    obsidianFullMode: "Full backup",
  ...
  zh: {
    ...
    delete: "删除",
    saveChanges: "保存修改",
    confirmDeleteJournalItem: "删除这条日志内容？此操作不可撤销。",
    journalItemUpdated: "日志内容已更新。",
    journalItemDeleted: "日志内容已删除。",
    failedUpdateJournalItem: "更新日志内容失败。",
    failedDeleteJournalItem: "删除日志内容失败。",
    refresh: "刷新",
    mapOutput: "地图输出",
    ...
    newWorkspace: "新建工作区",
    importBook: "导入书籍",
    initializeBook: "初始化书籍",
    initializingBook: "正在初始化...",
    selectedSource: "已选择",
    supportedSourceFormats: "支持：PDF、EPUB、DOCX、TXT、Markdown、HTML、RTF。",
    sourcePath: "源文件",
    sourcePathPlaceholder: "/Users/me/Books/book.pdf",
    selectSource: "选择源文件",
    workspaceTarget: "保存为",
    workspaceTargetOptional: "保存为（可选）",
    workspaceTargetPlaceholder: "/Users/me/Reading/book-reading",
    webWorkspaceTargetPlaceholder: "workspaces/book-name-reading",
    ...
    confirmDeleteWorkspace: "删除这本已初始化图书及其工作区内的全部笔记？此操作不可撤销。",
    ...
    obsidianExportMode: "导出模式",
    obsidianLearningArchiveMode: "学习档案（推荐）",
    obsidianFullMode: "完整备份",
